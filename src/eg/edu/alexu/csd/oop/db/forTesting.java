...
ob.executeStructureQuery("CREATE TABLE table_name1(column_name1 varchar, column_name2 int, column_name3 varchar)");
/*System.out.println(ob.executeUpdateQuery("INSERT INTO table_name1(column_NAME1, COLUMN_name3, column_name2) VALUES ('value1', 'value3', 5) "));
// System.out.println("	    "+ob.executeQuery("SELECT * FROM table_name1 WHERE coluMN_NAME2 < 6" )[0][1] ) ;
				int result;
				try {
					
					result = ob.executeUpdateQuery("UPDATE table_name1 SET COLUMN_NAME2=10 WHERE coLUmn_NAME2<6");
					System.out.println(result);
					System.out.println("		 "+ob.executeUpdateQuery("UPDATE table_name1 SET COLUMN_NAME2=10 WHERE coLUmn_NAME2<5"));
